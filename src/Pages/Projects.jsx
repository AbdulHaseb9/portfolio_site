    ...
    <div className=" w-full bg-secondary py-20 px-5 md:px-20">
      ...
      <div className="flex justify-center flex-wrap my-5 gap-x-5 gap-y-3">
        <button
          ...
          className={`rounded-md border-primary px-4 py-2 border-2 ${
            projects == "all"
        ...
        <button
          ...
          className={`px-4 py-2 rounded-md border-primary border-2 ${
            projects == "fullstack"
              ? `bg-transparent text-primary `
              : `bg-primary text-white`
          }`}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 place-items-center gap-y-5 my-6">
        ...
        ) : mywork.filter((item) => item.type == projects).length > 0 ? (
          mywork
