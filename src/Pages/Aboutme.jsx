  ...
  return (
    <div className='px-5 w-full flex items-center justify-center flex-col py-24 gap-y-20 md:flex-row lg:h-screen xl:px-20'>
      ...
      <div className='w-full md:w-1/2 flex flex-col justify-center gap-y-4'>
        <h2 className='text-2xl font-semibold tracking-wider'>I'm Haseeb Sheikh <span className='text-primary'>Web Developer</span></h2>
        <p className='text-lg text-gray'>Hi! My name is <span className='text-primary'>Haseeb Sheikh.</span> I am a Web Developer, and I'm very passionate and dedicated to my work. With 4 months internship experience and 6 months as an instructor.</p>
        <div className='grid grid-cols-1 lg:grid-cols-2 place-content-center gap-y-3'>
